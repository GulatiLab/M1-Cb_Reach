function [AssemblyTemplates,eigenvalues,lambda_max,score] = assembly_patterns(SpikeCount,opts)
...
% [V, D] = eig(cov(x));
%pick the components with the most variance,
[d, ind] = sort(diag(d), 'descend');
eigenvectors = eigenvectors(:, ind);
%columns of score have PC components ordered by variance
score = CorrMatrix * eigenvectors;
test = score * eigenvectors';
